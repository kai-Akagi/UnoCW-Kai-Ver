 ...
 *
 * <p>
 * Esta clase es el único punto de acceso para crear efectos de cartas. Las
 * clases concretas de efectos ({@code SkipEffect}, {@code ReverseEffect}, etc.)
 * son de acceso de paquete (sin {@code public}), así que nadie fuera de este
 * paquete puede crearlas directamente. Deben pedirlas a través de esta clase.
 *
 * <p>
 * <b>¿Por qué hacerlo así?</b><br>
 * Ocultar las clases concretas y exponer solo esta fábrica nos permite:
 * <ul>
 * <li>Cambiar cómo se implementa un efecto sin que el resto del código lo
 * sepa.</li>
 * <li>Tener un solo lugar donde se crean los efectos (control
 * centralizado).</li>
 * <li>Hacer el código más legible: {@code CardEffectFactory.createSkip()} es
 * claro.</li>
 * </ul>
 *
...
public class CardEffectFactory {
    ...
    /**
     * Constructor privado: no se puede instanciar esta clase. Todos sus métodos
     * son estáticos, así que no necesitas crear un objeto.
     */
     ...
     *
     * @return Un efecto que hace robar 2 cartas al siguiente jugador y lo
     * salta.
     */
     ...
     *
     * @return Un efecto que hace robar 4 cartas al siguiente jugador y lo
     * salta.
     */
