 ...
 *
 * <p>
 * Esta clase es responsable de crear el mazo completo de 108 cartas de UNO.
 * Nadie más en el sistema crea cartas directamente; toda carta nace aquí.
 *
 * <p>
 * <b>Patrón aplicado: Factory</b><br>
 * La idea del patrón Factory es tener un lugar centralizado para crear objetos
 * complejos. ¿Por qué es útil aquí?
 * <ul>
 * <li>Las 108 cartas tienen reglas precisas de composición (cuántas de cada
 * tipo). Si esa lógica estuviera dispersa, sería fácil cometer errores.</li>
 ...
 *
 * <p>
 * <b>Composición del mazo UNO (108 cartas):</b>
 * <ul>
...
public class CardFactory {
    ...
    /**
     * Constructor privado: esta clase no se puede instanciar. Su único método
     * público es estático.
     */
    private CardFactory() {
    }
     ...
     *
     * <p>
     * Mezclar el mazo aquí y no en el {@link uno.model.Deck} es una decisión
     * consciente: la fábrica entrega el producto listo para usarse.
     *
