...
public class GameModel {
    ...
    /**
     * Saca cartas del mazo hasta encontrar una que no sea comodín. La primera
     * carta de la partida no puede ser WILD (regla oficial UNO).
     *
     * FIX: los comodines descartados se colocaban en la pila de descarte, lo
     * que los convertía en la "carta activa" visible antes de empezar. Ahora se
     * acumulan en una lista temporal y se reinsertan al fondo del mazo de robo
     * para que puedan volver a aparecer durante el juego.
     */
