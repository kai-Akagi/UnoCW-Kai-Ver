...
public class LobbyView extends JPanel {
    ...
    /**
     * Actualiza el selector de capacidad sin disparar el listener de cambio. Se
     * usa para reflejar en los Peers el tamaño de sala elegido por el Host.
     *
    ...
    public void setCapacityDisplay(int capacity) {
        ...
        for (java.awt.event.ActionListener l : listeners) {
            capacitySelector.removeActionListener(l);
        }
        capacitySelector.setSelectedItem(capacity);
        for (java.awt.event.ActionListener l : listeners) {
            capacitySelector.addActionListener(l);
        }
    }
