 ...
 *
 * <p>
 * Es el único {@link JFrame} del programa. Usa {@link CardLayout} para cambiar
 * entre pantallas sin abrir nuevas ventanas.
 *
 * <p>
 * <b>Corrección:</b> Ahora recibe y propaga el {@link LobbyState} y la
 * {@link NetworkLayer} creados en {@link RegisterController}, evitando que
 * {@link LobbyController} cree instancias nuevas que rompían la sincronización
 * entre Host y Peer.
 *
...
public class MainWindow extends JFrame {
    ...
    /**
     * NetworkLayer creada en RegisterController y pasada al lobby. Se guarda
     * aquí para que GameController también pueda acceder a ella.
     */
...
//        this.lobbyState   = lobbyState;
     ...
     *
     * <p>
     * <b>Por qué recibe LobbyState y NetworkLayer:</b><br>
     * Ambos se crean en {@link RegisterController} donde se conoce el rol (Host
     * o Peer) y se establece la conexión. Si LobbyController los creara de
     * nuevo, el Peer tendría un LobbyState con código distinto al del Host, y
     * la NetworkLayer no estaría conectada.
     *
...
//        LobbyView       lobbyView       = new LobbyView();
    ...
    /**
     * Vuelve a la pantalla de registro y limpia el estado anterior. Se llama
     * cuando el jugador sale del lobby o termina la partida.
     */
