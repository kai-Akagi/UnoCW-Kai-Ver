...
import Eventos.GameEventListener;
 ...
 *
 * <p>
 * Valida los datos del jugador, crea la {@link GameSession}, el
 * {@link LobbyState} y la {@link NetworkLayer}, y los pasa juntos a
 * {@link MainWindow#showLobby} para que el lobby los use directamente sin crear
 * instancias nuevas.
 *
 * <p>
 * <b>Corrección:</b> Antes, {@code LobbyController} creaba su propio
 * {@code LobbyState}, perdiendo el código de sala del Host y provocando que el
 * Peer generara un código distinto al unirse.
 *
...
public class RegisterController {
    ...
    /**
     * Llamado cuando el usuario presiona "SIGUIENTE". Valida los datos y
     * pregunta el rol.
     */
     ...
     *
     * <p>
     * El {@link LobbyState} se crea aquí y su código de sala se almacena en la
     * {@link GameSession}. Ambos se pasan a {@link MainWindow#showLobby} para
     * que el {@code LobbyController} los use directamente.
     */
     ...
     *
     * <p>
     * El {@link LobbyState} del Peer comienza vacío: se poblará automáticamente
     * cuando lleguen los eventos {@code PlayerJoinedEvent} desde el Host a
     * través de la red.
     *
     * <p>
     * El código de sala que ingresa el Peer es solo referencial para el
     * usuario; la conexión real se hace por IP y puerto. El Host valida que el
     * código coincida antes de aceptar al Peer (fase futura).
     */
    ...
    // ─────────────────────────────────────────────
    /**
     * Valida el nombre del jugador. Reglas: entre 3 y 15 caracteres, solo
