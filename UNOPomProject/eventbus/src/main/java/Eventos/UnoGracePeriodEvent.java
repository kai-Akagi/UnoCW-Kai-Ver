...
/**
 * Evento publicado cuando un jugador juega su penúltima carta y le queda solo
 * 1.
 *
 * <p>
 * Al recibirlo, la GUI debe:
 * <ol>
 * <li>Mostrar el botón "¡UNO!" habilitado en modo urgente.</li>
 * <li>Iniciar un temporizador de 5 segundos.</li>
 * <li>Si el jugador presiona UNO antes de que expire el timer → turno termina
 * sin penalización.</li>
 * <li>Si el timer expira sin presionar UNO → se aplican 2 cartas de
 * penalización.</li>
 * </ol>
 *
 * <p>
