 ...
 * </ul>
 *
 * <p><b>¿Por qué un evento de intención separado?</b><br>
 * Porque en la arquitectura P2P el Peer no puede decidir qué carta saca del mazo:
 * esa decisión pertenece al Host (fuente de verdad). El Peer solo comunica
 * que quiere robar; el Host actúa y le informa el resultado.
 *
 * <p>Sigue el mismo patrón que {@link StartRequestedEvent}: un jugador
 * expresa una intención y el Host decide la respuesta.
 */
