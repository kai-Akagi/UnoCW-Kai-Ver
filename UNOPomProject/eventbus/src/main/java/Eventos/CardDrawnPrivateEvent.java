 ...
 *
 * <p>Este evento solo llega al jugador que robó la carta.
 * Contiene la carta real para que su GameModel local la agregue
 * a su mano y su GUI la muestre.
 *
 * <p>La audiencia de este evento es {@code PRIVATE}, así que la
 * {@code NetworkLayer} del Host lo envía únicamente al peer destino,
 * no a todos.
 */
