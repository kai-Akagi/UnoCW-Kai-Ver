 ...
 *
 * <p>La GUI muestra un selector de color cuando el jugador juega WILD.
 * El color elegido viaja como este evento para que el GameModel
 * del Host actualice la carta activa con el nuevo color.
 */
