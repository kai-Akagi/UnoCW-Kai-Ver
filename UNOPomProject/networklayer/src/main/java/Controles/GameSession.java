 ...
 *
 * <p>
 * Responde a las preguntas más básicas de cualquier componente:
 * <ul>
 ...
 *
 * <p>
 * <b>¿Por qué existe esta clase?</b><br>
 ...
 * como atributo propio. Con {@code GameSession} hay un solo lugar donde vive
 * esa información y todos la consultan ahí.
 *
 * <p>
 * <b>Ciclo de vida:</b> Se crea cuando el jugador completa el registro (nombre
 * + avatar) y vive hasta que cierra la aplicación o vuelve al menú principal
 * para registrarse de nuevo.
 *
 * <p>
 * <b>¿Es un Singleton?</b><br>
 * No literalmente, pero en la práctica solo existe una instancia cada
 * ejecución. Se crea en el punto de entrada (la pantalla de registro) y se pasa
 * por referencia a quien la necesite. Evitamos el Singleton aquí porque la
 * sesión sí puede "reiniciarse" si el jugador vuelve al menú principal, y un
 * Singleton complicaría ese reset.
 *
