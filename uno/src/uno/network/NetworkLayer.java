...
public class NetworkLayer {
    ...
    private uno.model.Card.Color parseCardColor(String s) {
        switch (s) {
            case "RED":    return uno.model.Card.Color.RED;
            case "BLUE":   return uno.model.Card.Color.BLUE;
            case "GREEN":  return uno.model.Card.Color.GREEN;
            case "YELLOW": return uno.model.Card.Color.YELLOW;
            default:       return uno.model.Card.Color.WILD;
        }
    }
