 ...
 *
 * <p>Cada par de jugadores conectados tiene un objeto {@code PeerConnection}
 * de este lado. Se encarga de dos cosas simples:
 * <ul>
 *   <li><b>Enviar</b> mensajes de texto por el socket.</li>
 *   <li><b>Escuchar</b> mensajes entrantes en un hilo propio y notificar
 *       cuando llega uno.</li>
 * </ul>
 *
 ...
 *
 * <p><b>Protocolo:</b> Un mensaje por línea. El emisor termina cada mensaje
...
public class PeerConnection {
    ...
    /**
     * Para escribir mensajes al socket.
     * {@code PrintWriter} con autoflush: cada vez que escribimos una línea,
     * se envía automáticamente sin necesidad de llamar a flush().
     */
    private final PrintWriter writer;

    /**
     * Para leer mensajes del socket.
     * {@code BufferedReader} lee línea a línea de forma eficiente.
     */
    private final BufferedReader reader;

    /**
     * La función que se llama cuando llega un mensaje.
     * Recibe el nombre del peer y el mensaje recibido.
     * Esto es el patrón callback: quien crea la conexión decide qué hacer
     * con los mensajes, no la conexión misma.
     */
     ...
     *
     * <p>El hilo corre en segundo plano (daemon) y llama a
     * {@code onMessageReceived} cada vez que llega una línea completa.
     * Si la conexión se cierra o hay un error, el hilo termina solo.
     */
     ...
     *
     * <p>El mensaje debe estar serializado (JSON en una línea).
     * El {@code PrintWriter} con autoFlush se encarga de que llegue
     * inmediatamente sin necesidad de buffering manual.
     *
    ...
    /**
     * Actualiza el nombre de este peer.
     * Se usa cuando el nombre temporal se reemplaza por el nombre real del jugador.
     *
