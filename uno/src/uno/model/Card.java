...
import uno.model.rules.CardEffect;
 
/**
 * Representa una carta del juego UNO.
 *
 * <p>Una carta tiene tres características:
 * <ul>
 ...
 * <ul>
 *   <li><b>Strategy:</b> el campo {@code effect} encapsula el comportamiento especial
 *       de la carta. Así evitamos un bloque enorme de ifs.</li>
 *   <li><b>Factory:</b> estas cartas son creadas exclusivamente por {@link uno.factory.CardFactory},
 *       no directamente por el resto del código.</li>
 * </ul>
 */
public class Card {
 
    /**
     * Los colores posibles de una carta UNO.
     * WILD se usa para cartas comodín que no tienen color fijo.
     */
    public enum Color {
    ...
    /**
     * El valor de la carta en texto.
     * Ejemplos: "0", "7", "SKIP", "REVERSE", "DRAW_TWO", "WILD", "WILD_DRAW_FOUR".
     */
    private final String value;
 
    /**
     * El comportamiento especial de esta carta.
     * Es null si la carta es numérica (no hace nada especial al jugarse).
     *
     * <p><b>Por qué así:</b> En vez de preguntar "¿qué tipo eres?" con ifs,
     * le decimos a la carta "ejecuta tu efecto" y ella sabe qué hacer.
     * Eso es el patrón Strategy: el comportamiento es intercambiable.
     */
     ...
     * tras un comodín. El color activo puede diferir del color de la carta activa.
     *
    ...
    /**
     * Devuelve esta carta como texto legible.
     * Ejemplo: "RED-7", "BLUE-SKIP", "WILD_DRAW_FOUR".
     */
    @Override
