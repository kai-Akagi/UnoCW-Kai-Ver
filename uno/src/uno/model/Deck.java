...
import uno.factory.CardFactory;
 ...
 *
 * <p>Existe exactamente un mazo por partida. Esta clase aplica el patrón
 * <b>Singleton</b> para garantizarlo: no importa cuántas veces pidas el mazo,
 * siempre recibes el mismo objeto.
 *
 * <p><b>¿Por qué Singleton aquí?</b><br>
 * Imagina que dos partes del juego pudieran crear su propio mazo.
 * Un jugador robaría cartas de un mazo y otro de otro distinto.
 * Las cartas se duplicarían y el juego sería incoherente. Con Singleton
 * garantizamos que todos comparten el mismo mazo físico.
 *
 * <p><b>Responsabilidades de esta clase:</b>
 * <ul>
 ...
 *   <li>Recargar la pila de robo usando las cartas del descarte cuando se acaba.</li>
 * </ul>
 *
...
public class Deck {
     ...
     * Cuando se acaba, se recarga con las cartas del descarte.
     */
    private List<Card> drawPile;

    /**
     * La pila de descarte: las cartas ya jugadas.
     * La carta en la cima (última de la lista) es la carta activa en la mesa.
     */
    private List<Card> discardPile;

    /**
     * Constructor privado: nadie puede crear un Deck con {@code new Deck()}.
     * La única forma de obtenerlo es a través de {@link #getInstance()}.
     */
    private Deck() {
     ...
     *
     * <p>Hay que llamar a este método al inicio de cada partida nueva.
     * El mazo se llena usando la {@link CardFactory} (patrón Factory)
     * y las cartas ya vienen mezcladas.
     */
    public void reset() {
        drawPile    = new ArrayList<>(CardFactory.createFullDeck());
     ...
     *
     * <p>Si la pila de robo está vacía, intenta recargarla con las cartas
     * del descarte (excepto la carta que está en la mesa actualmente).
     *
    ...
    /**
     * Devuelve la carta que está en la cima del descarte (la carta activa en la mesa).
     *
