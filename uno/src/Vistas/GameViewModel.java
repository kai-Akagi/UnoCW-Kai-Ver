 ...
 *
 * <p>Contiene exactamente los datos que {@link GameView} necesita para dibujarse.
 ...
 *
 * <p><b>¿Por qué existe este objeto?</b><br>
 * La View no debe conocer al {@link GameState} directamente porque:
 * <ul>
 *   <li>GameState tiene lógica de dominio (índices, listas mutables) que
 *       no le corresponde a la View manejar.</li>
 *   <li>Algunos datos deben filtrarse: la View nunca debe ver las cartas
 *       reales de los oponentes, solo cuántas tienen.</li>
 *   <li>Si GameState cambia su estructura, solo GameController necesita
 *       actualizarse, no la View.</li>
 * </ul>
 *
 * <p>Este objeto es inmutable una vez creado: la View lo lee pero no lo modifica.
 */
public class GameViewModel {
     ...
     *
     * <p>El filtrado ocurre aquí: los oponentes solo exponen cuántas cartas
     * tienen, nunca cuáles.
     *
    ...
    /**
     * Constructor alternativo para actualizar desde datos de red
     * (cuando no tenemos el GameState completo, solo los campos que mandó el Host).
     *
